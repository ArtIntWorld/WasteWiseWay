            ...
            <div class="wrapper">
                <div class="payment">
                    ...
                    <form class="form" method="post">
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Holder" pattern="^[A-Z]+[a-zA-Z ]*$">
                        ...
                        <div class="card space icon-relative">
                            ...
                            <input type="text" readonly="" class="input" value="<%=request.getParameter("amount")%>">
                    </div>
                ...
                <%
                    if (request.getParameter("btnpay") != null) {
                        String updQry = "update tbl_wasterequest set supervisor_pay='1' where wastereq_id ='" + request.getParameter("id") + "'";
