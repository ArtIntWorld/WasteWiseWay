...
<html>
    <head>
        ...
        if(request.getParameter("btnsave")!=null)
        {
            ...
            String selQry="select * from tbl_supervisor where supervisor_id='"+session.getAttribute("supid")+"'";
            ResultSet rs = con.selectCommand(selQry);
            rs.next();
            String currentPassword=rs.getString("supervisor_password");
            
            if(cPassword.equals(currentPassword))
            {
                if(nPassword.equals(ccPassword))
                {
                    String upQry = "update tbl_supervisor set supervisor_password='"+nPassword+"' where supervisor_id='"+session.getAttribute("supid")+"'";
                    out.println(upQry);
