        ...
        <div id="tab" align="center">
            <form method="post" enctype="multipart/form-data" action="../Assets/ActionPages/EmployeeUploadAction.jsp">
                ...
                <table border="1" align="center" cellpadding="10" >
                    ...
                    <tr>
                        <td>Email</td>
                        <td><input type="email" name="txtemail" pattern=".*@gmail\.com$" required="required"></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                        <td>
                    ...
                    <tr>
                        <td>Contact</td>
                        <td><input type="text" name="txtcontact" required="required" maxlength="10" autocomplete="off" pattern="[7-9]{1}[0-9]{9}" title="Phone number starting with digits from 7-9 and remaing 9 digits from 0-9"></td>
                    </tr>
                    <tr>
                        <td>Gender</td>
                        <td>
