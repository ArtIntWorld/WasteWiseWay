<%-- 
    Document   : RoadWasteUploadAction
    Created on : 10 Feb, 2023, 12:02:54 PM
    Author     : ardra
--%>
...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\RoadwastePhoto\\";//path for storing image
                ...
                String InsQry = "insert into tbl_rdwaste(place_id,rdwaste_landmark,rdwaste_details,rdwaste_latitude,rdwaste_longitude,rdwaste_photo,rdwaste_date,user_id)"
                        + "values('" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','" + photo + "',curdate(),'"+session.getAttribute("usid")+"')";
System.out.print(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
              window.location.href = '../../User/RoadWaste.jsp'
            }, 40);
        </script>
        <%
                }
